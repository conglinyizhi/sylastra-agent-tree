...
When OpenCode launches child agent sessions, sylastra-agent-tree can open panes for those sessions automatically.
...
Edit `~/.config/opencode/sylastra-agent-tree.json` (or `.jsonc`):
