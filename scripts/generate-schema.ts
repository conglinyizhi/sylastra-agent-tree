...
const outputPath = join(rootDir, 'sylastra-agent-tree.schema.json');
...
const jsonSchema = {
  ...
  title: 'sylastra-agent-tree',
  description:
    'Configuration schema for sylastra-agent-tree plugin for OpenCode',
};
